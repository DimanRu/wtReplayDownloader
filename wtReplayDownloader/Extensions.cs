...
{
    public static async Task DownloadAsync(this HttpClient client, string url, string path, IProgress<double> progress = null, CancellationToken cancellationToken = default)
    {
